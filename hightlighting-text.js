!function(e, t) {
    ...
    return function(e) {
        ...
        var i = function(e) {
            ...
            u = function(e, t) {
                return "position:absolute;z-index:9999;border-radius:3px;top:" + e + "px;left:" + t + "px;"
            },
            l = function(e) {
                var t = e.arrowSize;
        ...
        t.default = (j = {
            search: {
                isActive: !0,
                  ...
                  icon: '<span style="color:#fff" uk-icon="search" title="Tìm kiếm" />'
            },
            facebook: {
                isActive: !0,
                url: "https://www.facebook.com/sharer/sharer.php?u=PAGE_URL&quote=TEXT_SELECTION", //Edit facebook sharing link [note the code TEXT_SELECTION and PAGE_URL]
            ...
            config: function(e) {
                return void 0 !== e.search && (j.search.isActive = e.search), void 0 !== e.facebook && (j.facebook.isActive = e.facebook), e.backgroundColor && (T = e.backgroundColor), e.iconColor && (k = e.iconColor), e.selectableElements && (x = e.selectableElements), this
            },
